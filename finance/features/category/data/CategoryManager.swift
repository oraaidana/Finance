...
//
//  Implementation of CategoryRepositoryProtocol.
//  Manages spending categories with UserDefaults persistence.
//

import SwiftUI
import Combine

class CategoryManager: ObservableObject, CategoryRepositoryProtocol {
