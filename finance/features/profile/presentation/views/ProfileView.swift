...
struct ProfileView: View {
    ...
    var body: some View {
        List {
            ...
            Section {
                NavigationLink(
                    destination: PlaceholderView(title: "Privacy & Security")
                ) {
                    SettingsRow(
                        icon: "lock.fill",
                ...
                NavigationLink(
                    destination: PlaceholderView(title: "Help & Support")
                ) {
                    SettingsRow(
...
struct AboutView: View {
    var body: some View {
        List {
            ...
            Section {
                Text(
                    "QarzhyAI is a finance tracker app with ML integration for smart expense tracking and financial recommendations."
                )
                .font(.subheadline)
                .foregroundColor(.secondary)
            } header: {
